...
class Server extends EventEmitter {
   ...
   * @return {void}
   */
  handleMessage(message:DataDump|ProviderDump|ActiveProviderDump|ReceiverDump|PeerDump|PeerSubscriptionDump|PeerSync|PeerSyncResponse|BraidEvent|PublisherOpen|PublisherClose|PublisherPeerMessage, peerId:number) {
