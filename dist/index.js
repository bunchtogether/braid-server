...
class Server extends EventEmitter {
   ...
   */
  constructor(uwsServer                , websocketPattern         = '/*', websocketBehavior          = { compression: 0, closeOnBackpressureLimit: false, maxPayloadLength: MAX_PAYLOAD_LENGTH, maxBackpressure: MAX_BACKPRESSURE, idleTimeout: 56 }, options                   = {}) {
    super();
